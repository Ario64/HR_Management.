...
public class LeaveTypeController : ControllerBase
{
    ...
    public async Task<ActionResult<IReadOnlyList<LeaveTypeDto>>> Get()
    {
        ...
        var linkBuilder = new LinkBuilder<LeaveTypeController>(Url,_httpContextAccessor);
    ...
    [HttpPost]
    [ProducesResponseType(typeof(LeaveTypeResource), StatusCodes.Status201Created)]
